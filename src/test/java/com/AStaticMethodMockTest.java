...
@PrepareForTest({ UtilityClass.class}) //Class name where the Static method is present
public class AStaticMethodMockTest {
    ...
    public void powerMockito_MockingAStaticMethodCall() {
        ...
        //PowerMockito.verifyStatic(Mockito.class);
